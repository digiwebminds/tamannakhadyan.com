...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $installment =$_POST['installment'];
        ...
        $sql = "INSERT INTO `loans` (`customer_id`, `customer_name`, `principle`, `comment`, `dor`, `loan_type`, `installment`, `roi`) VALUES ('$customerid', '$customername', '$principle', '$comment', '$dorloan', '$loancategory', '$installment', '$roi')";
        ...
        <form action="" method="POST">
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="sm:col-span-2">
                    <label for="dorloan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">D.O.R</label>
              ...
              <div class="w-full">
                ...
                <div class="w-full">
                    <label for="roi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rate of Interest
                        ...
                        <input type="number" name="roi" id="roi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                    </div>
                    <div class="w-full">
                        <label for="installment" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Installment Amount (for CC)
                            </label>
